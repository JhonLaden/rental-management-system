...
INSERT INTO `item` (`item_id`, `name`, `type`, `size`, `deposit_cost`, `rental_cost`, `quantity`) VALUES
(7, 'sadfsa', 'gown', 21.00, 234.00, 3242.00, 1),
(8, 'white gown', 'gown', 21.00, 3432.00, 23423.00, 1),
(9, 'tuxedo', 'suit', 23.00, 343.00, 212.00, 1);
